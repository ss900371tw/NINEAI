...
GOVERNANCE_2 = [
    {"title": "可解釋性分析", "desc": "詳述模型決策依據，說明是否導入 SHAP (Shapley Value)、Grad-CAM 等技術產生熱力圖 (Heatmap) 或特徵權重，輔助醫師驗證輸出結果。"},
    {"title": "AI生命週期管理", "desc": "實施臨床部署後的持續監測與定期性能評估計畫，確保系統能適應醫療數據漂移，並涵蓋維護、更新與模型退役之標準作業程序。"}
]
